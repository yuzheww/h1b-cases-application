...
-- 1
-- Combines all the information that users can change in a view
...
-- takes two parameters and updates the case status of the given case
...
-- 3
-- takes four parameters and updates the attorney information of the given case
-- return the updated case
...
-- 4
-- deletes case in the tables that have case number as a foreign key before a case is deleted in ApplicationInfo
...
-- 6
-- insert a case with its basic information: case number, case status, case submission date, case decision date
